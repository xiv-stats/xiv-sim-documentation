...
var mechanicName = "LightRampantDemo-6P";
			...
			mechanic = new ExecuteMultipleEvents {
				events = new List<MechanicEvent> {
					...
					new SpawnTethersBetweenPlayers
					{
						...
						tetherIndices = new List<int> {0, 1, 1, 2, 2, 3, 3, 4, 4, 5 },
		...
		new MechanicProperties {
			...
			mechanic = new ExecuteMultipleEvents
			{
				events = new List<MechanicEvent>
				{
					...
					new SpawnMechanicEvent {referenceMechanicName = "Tower-1-Offset2-L", isPositionRelative = true, isRotationRelative = true, rotation = 60},
					new SpawnMechanicEvent {referenceMechanicName = "Tower-1-Offset2-L", isPositionRelative = true, isRotationRelative = true, rotation = 120},
					...
					new SpawnMechanicEvent {referenceMechanicName = "Tower-1-Offset2-L", isPositionRelative = true, isRotationRelative = true, rotation = 240},
					new SpawnMechanicEvent {referenceMechanicName = "Tower-1-Offset2-L", isPositionRelative = true, isRotationRelative = true, rotation = 300},
				}
			},
		}
	},
	{
		...
		new MechanicProperties {
			...
			mechanic = new ExecuteMultipleEvents
			{
				events = new List<MechanicEvent>
				{
					new SpawnMechanicEvent {referenceMechanicName = "Tower-1-D", isPositionRelative = true, isRotationRelative = true, position = Vector3.right * 5},
